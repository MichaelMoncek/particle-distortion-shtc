...
\begin{subsection}{Distortion as a minimization problem}
    ...
    Next we will make an observation about the order of approximation of $\AA_{a}$ and $\AA^double_a$.
...
where \begin{equation}
    ...
    \QQ_a =  \left( \sum_b w_{ab} \xx_{ab} \otimes \xx_{ab} \right)
\end{equation}
The differential of the distortion field with respect to position $\xx_a$ is then equal to:
\begin{equation}
