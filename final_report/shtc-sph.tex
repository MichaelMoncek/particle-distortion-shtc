...
Next we will compute the differential of the energy:
\begin{equation}
    \diff U = \sum_{a} m_{a} \left( \frac{\pd \epsilon_a}{\pd \rho} \diff \rho_a + 
    \frac{\pd \epsilon_a}{\pd \AA}: \diff \AA_{a}\right) 
\end{equation}

Using \ref{eq:dA} we can calculate the differential of the energy $U_h$ as: 
\begin{equation}
    \begin{aligned} 
