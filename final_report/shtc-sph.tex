...
\begin{subsubsection}{Numerical analysis}
   We want to solve (numerically) the following ODE system:
   \begin{subequations}
       \begin{equation}
           \dot \xx = \vv
       \end{equation}
   ...
   The last equation can be though of as $\LL$ being the generator of the one parameter $C_0$-semigroup $\AA(t)$ ie
   \[
   ...
   \[
    ...
    timesteping.
    However, we will get a positive result in the second case.
    ...
    \] 
    this will also hold for our mid-point rule (which is the
    Cayley map in disguise):
    \[
